  ...
  return (
    <main className="min-h-[calc(100svh-80px)] grid place-items-center px-4">
      <div className="w-full max-w-md rounded-2xl border bg-card text-card-foreground shadow-sm p-6">
        <Logo />
        <h1 className="mt-4 text-2xl font-semibold">Register</h1>
            ...
            <form onSubmit={onEmail} className="space-y-3">
              ...
              <label className="mt-2 flex items-start gap-3 text-sm">
                <input
                  ...
                  className="mt-1 h-4 w-4 rounded border-border bg-background accent-[hsl(var(--brand-sky))]"
                />
                <span>
                  Accept policies
              ...
              <Button type="submit" className="w-full rounded-2xl" disabled={loading || !accept}>
                Create your account
              </Button>
            </form>
          )}
